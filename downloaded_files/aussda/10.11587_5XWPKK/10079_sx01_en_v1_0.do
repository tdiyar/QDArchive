...
/* Linking Austrian ICCP Data to other countries' ICCP datasets at the aggregate level 
(replication data set WEP articles)
DK-answers on issue credibility coded as non-selected issues
*/
* ============================================================================ *
...
save "10079_da_en_v1_0_pre_aggregated(replication)", replace
